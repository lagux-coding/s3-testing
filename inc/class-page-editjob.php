                ...
                case 'job':
                    ...
                    <table class="form-table">
                        <tr>
                            ...
                            <td>
                                <input name="name" type="text" id="name" placeholder="<?php esc_attr_e('Job Name'); ?>" data-empty="<?php esc_attr_e('New Job'); ?>" value="<?php echo esc_attr(S3Testing_Option::get($jobid, 'name')); ?>" class="regular-text" />
                            </td>
                        </tr>
                    </table>
